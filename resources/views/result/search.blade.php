                                ...
                                <table class="table table-hover">
                                    ...
                                    @foreach($students as $key=>$student)
                                        <tr>
                                            ...
                                            <td>@foreach($class as $val) @if($val->id == $student->id_lop) Khóa {{$val->khoa}} - Lớp {{$val->lop}} @endif @endforeach</td>
                                            <td><a href="{{url('result/show') . '/' . $student->id}}" title="Xem điểm của {{$student->ho_ten_dem. ' ' . $student->ten}}"><span class="fa fa-street-view"></span></a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
